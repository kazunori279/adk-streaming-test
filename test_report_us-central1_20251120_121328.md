...
**gemini-2.0-flash-exp**: "it is 9/11 p.m. in Tokyo Japan"

**gemini-2.0-flash-live-001**: "it is 9:11 p.m. in Tokyo Japan"

**gemini-live-2.5-flash-preview**: "the current time in Tokyo Japan is 912 p.m. on Thursday November 20th 2025 Tokyo observes Japan's Standard time jst which is UTC GMT + 9 hours and does not use daylight saving time"

**gemini-2.5-flash-native-audio-preview-09-2025**: "the current time in Tokyo Japan is 912 p.m."

### Vertex AI

**gemini-2.0-flash-exp**: ""

**gemini-live-2.5-flash-preview-native-audio**: "the current time in Tokyo Japan is 913 p.m."

**gemini-live-2.5-flash-preview-native-audio-09-17**: "right now it is 9:13 p.m. in Tokyo Japan"
...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.11.14/x64/lib/python3.11/site-packages/google/adk/runners.py", line 887, in run_live
    async for event in agen:
  File "/opt/hostedtoolcache/Python/3.11.14/x64/lib/python3.11/site-packages/google/adk/runners.py", line 654, in _exec_with_plugin
    async for event in agen:
  File "/opt/hostedtoolcache/Python/3.11.14/x64/lib/python3.11/site-packages/google/adk/runners.py", line 876, in execute
    async for event in agen:
  File "/opt/hostedtoolcache/Python/3.11.14/x64/lib/python3.11/site-packages/google/adk/agents/base_agent.py", line 324, in run_live
    async for event in agen:
  ...
  File "/opt/hostedtoolcache/Python/3.11.14/x64/lib/python3.11/contextlib.py", line 210, in __aenter__
    return await anext(self.gen)
           ^^^^^^^^^^^^^^^^^^^^^
  File "/opt/hostedtoolcache/Python/3.11.14/x64/lib/python3.11/site-packages/google/adk/models/google_llm.py", line 332, in connect
