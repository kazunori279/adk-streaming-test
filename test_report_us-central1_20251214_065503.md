...
## Test Summary
- **Test Date**: 2025-12-14 06:55:03
- **Test Type**: COMBINED (Text + Voice)
- **Google ADK Version**: 1.21.0
- **Total Tests**: 14
- **Passed Tests**: 10
- **Failed Tests**: 4
- **Success Rate**: 71.4%
...
**gemini-live-2.5-flash-native-audio**:
  - Text (audio transcript): ❌ FAIL (retries: 2) - Reason: Exception: received 1008 (policy violation) models/gemini-live-2.5-flash-native-audio is not found for API version v1alpha, or is not supported for bidiGenerateContent; then sent 1008 (policy violation) models/gemini-live-2.5-flash-native-audio is not found for API version v1alpha, or is not supported for bidiGenerateContent
...
**gemini-2.0-flash-exp**: "it is 353 p.m. in Tokyo Japan"

**gemini-2.5-flash-native-audio-preview-09-2025**: "the current time in Tokyo Japan is 353 p.m. it is Japan Standard Time"
...
**gemini-live-2.5-flash-preview-native-audio**: "the current time in Tokyo Japan is 354 p.m."

**gemini-live-2.5-flash-preview-native-audio-09-17**: "it is currently 3:54 p.m. in Tokyo Japan"

**gemini-live-2.5-flash-native-audio**: "it's 354 p.m. in Tokyo Japan right now"

## Error Traces

### Google AI Studio

#### gemini-live-2.5-flash-native-audio (text)
...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.11.14/x64/lib/python3.11/site-packages/google/adk/runners.py", line 1000, in run_live
    async for event in agen:
  File "/opt/hostedtoolcache/Python/3.11.14/x64/lib/python3.11/site-packages/google/adk/runners.py", line 722, in _exec_with_plugin
    async for event in agen:
  File "/opt/hostedtoolcache/Python/3.11.14/x64/lib/python3.11/site-packages/google/adk/runners.py", line 989, in execute
    async for event in agen:
  File "/opt/hostedtoolcache/Python/3.11.14/x64/lib/python3.11/site-packages/google/adk/agents/base_agent.py", line 327, in run_live
    async for event in agen:
  File "/opt/hostedtoolcache/Python/3.11.14/x64/lib/python3.11/site-packages/google/adk/agents/llm_agent.py", line 484, in _run_live_impl
    async for event in agen:
...
websockets.exceptions.ConnectionClosedError: received 1008 (policy violation) models/gemini-live-2.5-flash-native-audio is not found for API version v1alpha, or is not supported for bidiGenerateContent; then sent 1008 (policy violation) models/gemini-live-2.5-flash-native-audio is not found for API version v1alpha, or is not supported for bidiGenerateContent
```
...
- **gemini-live-2.5-flash-native-audio (text)**: Unexpected failure - requires investigation
  - Failure Reason: Exception: received 1008 (policy violation) models/gemini-live-2.5-flash-native-audio is not found for API version v1alpha, or is not supported for bidiGenerateContent; then sent 1008 (policy violation) models/gemini-live-2.5-flash-native-audio is not found for API version v1alpha, or is not supported for bidiGenerateContent
- **gemini-live-2.5-flash-native-audio (voice)**: Unexpected failure - requires investigation
  - Failure Reason: Exception: received 1008 (policy violation) models/gemini-live-2.5-flash-native-audio is not found for API version v1alpha, or is not supported for bidiGenerateContent; then sent 1008 (policy violation) models/gemini-live-2.5-flash-native-audio is not found for API version v1alpha, or is not supported for bidiGenerateContent
