...
### Test Type Breakdown
- **Text Tests**: 3/7 passed (42.9%)
- **Voice Tests**: 3/7 passed (42.9%)

### Retry Statistics
- **Tests requiring retries**: 8/14
...
**gemini-2.0-flash-exp**:
  - Text: ❌ FAIL (retries: 2) - Reason: Exception: 1008 None. Publisher Model `projects/gcp-samples-ic0/locations/us-central1/publishers/google/models/gemini-2.0-flash-exp` was not foun
  - Voice: ❌ FAIL (retries: 2) - Reason: Exception: 1008 None. Publisher Model `projects/gcp-samples-ic0/locations/us-central1/publishers/google/models/gemini-2.0-flash-exp` was not foun

**gemini-live-2.5-flash-preview-native-audio**:
  - Text (audio transcript): ❌ FAIL (retries: 2) - Reason: Exception: 1008 None. Publisher Model `projects/gcp-samples-ic0/locations/us-central1/publishers/google/models/gemini-live-2.5-flash-preview-nati
  - Voice: ❌ FAIL (retries: 2) - Reason: Exception: 1008 None. Publisher Model `projects/gcp-samples-ic0/locations/us-central1/publishers/google/models/gemini-live-2.5-flash-preview-nati
...
**gemini-2.5-flash-native-audio-preview-09-2025**: "the current time in Tokyo Japan is 9:31 a.m."

**gemini-2.5-flash-native-audio-preview-12-2025**: "the current time in Tokyo Japan is 9:31 a.m."
...
**gemini-live-2.5-flash-native-audio**: "it's 9:32 a.m. in Tokyo Japan right now"
...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.11.15/x64/lib/python3.11/site-packages/google/adk/agents/llm_agent.py", line 503, in _run_live_impl
    async for event in agen:
  File "/opt/hostedtoolcache/Python/3.11.15/x64/lib/python3.11/site-packages/google/adk/flows/llm_flows/base_llm_flow.py", line 506, in run_live
...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.11.15/x64/lib/python3.11/site-packages/websockets/asyncio/connection.py", line 322, in recv
    raise self.protocol.close_exc from self.recv_exc
websockets.exceptions.ConnectionClosedError: received 1008 (policy violation) Publisher Model `projects/gcp-samples-ic0/locations/us-central1/publishers/google/models/gemini-2.0-flash-exp` was not foun; then sent 1008 (policy violation) Publisher Model `projects/gcp-samples-ic0/locations/us-central1/publishers/google/models/gemini-2.0-flash-exp` was not foun
...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.11.15/x64/lib/python3.11/site-packages/google/genai/errors.py", line 163, in raise_error
    raise cls(status_code, response_json, response)
google.genai.errors.APIError: 1008 None. Publisher Model `projects/gcp-samples-ic0/locations/us-central1/publishers/google/models/gemini-2.0-flash-exp` was not foun
```
...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.11.15/x64/lib/python3.11/site-packages/websockets/asyncio/connection.py", line 322, in recv
    raise self.protocol.close_exc from self.recv_exc
websockets.exceptions.ConnectionClosedError: received 1008 (policy violation) Publisher Model `projects/gcp-samples-ic0/locations/us-central1/publishers/google/models/gemini-live-2.5-flash-preview-nati; then sent 1008 (policy violation) Publisher Model `projects/gcp-samples-ic0/locations/us-central1/publishers/google/models/gemini-live-2.5-flash-preview-nati
...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.11.15/x64/lib/python3.11/site-packages/google/genai/errors.py", line 163, in raise_error
    raise cls(status_code, response_json, response)
google.genai.errors.APIError: 1008 None. Publisher Model `projects/gcp-samples-ic0/locations/us-central1/publishers/google/models/gemini-live-2.5-flash-preview-nati
```
...
#### gemini-live-2.5-flash-preview-native-audio (voice)
...
#### gemini-live-2.5-flash-preview-native-audio-09-17 (voice)
...
- **gemini-2.0-flash-exp (voice)**: Unexpected failure - requires investigation
  - Failure Reason: Exception: 1008 None. models/gemini-2.0-flash-exp is not found for API version v1alpha, or is not supported for bidiGenerateContent. Call ListMod
- **gemini-2.0-flash-exp (text)**: Unexpected failure - requires investigation
  - Failure Reason: Exception: 1008 None. Publisher Model `projects/gcp-samples-ic0/locations/us-central1/publishers/google/models/gemini-2.0-flash-exp` was not foun
- **gemini-live-2.5-flash-preview-native-audio (text)**: Unexpected failure - requires investigation
  - Failure Reason: Exception: 1008 None. Publisher Model `projects/gcp-samples-ic0/locations/us-central1/publishers/google/models/gemini-live-2.5-flash-preview-nati
- **gemini-live-2.5-flash-preview-native-audio-09-17 (text)**: Unexpected failure - requires investigation
  - Failure Reason: Exception: 1008 None. Publisher Model `projects/gcp-samples-ic0/locations/us-central1/publishers/google/models/gemini-live-2.5-flash-preview-nati
- **gemini-2.0-flash-exp (voice)**: Unexpected failure - requires investigation
  - Failure Reason: Exception: 1008 None. Publisher Model `projects/gcp-samples-ic0/locations/us-central1/publishers/google/models/gemini-2.0-flash-exp` was not foun
- **gemini-live-2.5-flash-preview-native-audio (voice)**: Unexpected failure - requires investigation
  - Failure Reason: Exception: 1008 None. Publisher Model `projects/gcp-samples-ic0/locations/us-central1/publishers/google/models/gemini-live-2.5-flash-preview-nati
- **gemini-live-2.5-flash-preview-native-audio-09-17 (voice)**: Unexpected failure - requires investigation
  - Failure Reason: Exception: 1008 None. Publisher Model `projects/gcp-samples-ic0/locations/us-central1/publishers/google/models/gemini-live-2.5-flash-preview-nati
