...
## Test Summary
- **Test Date**: 2026-01-23 00:30:23
- **Test Type**: COMBINED (Text + Voice)
- **Google ADK Version**: 1.23.0
- **Total Tests**: 14
- **Passed Tests**: 12
- **Failed Tests**: 2
- **Success Rate**: 85.7%
...
**gemini-2.0-flash-exp**: "it is 9:28 a.m. in Tokyo Japan"

**gemini-2.5-flash-native-audio-preview-09-2025**: "the current time in Tokyo Japan is 9:28 a.m."

**gemini-2.5-flash-native-audio-preview-12-2025**: "the current time in Tokyo Japan is 9:29 a.m."

### Vertex AI

**gemini-2.0-flash-exp**: ""

**gemini-live-2.5-flash-preview-native-audio**: "the current time in Tokyo Japan is 9:30 a.m."

**gemini-live-2.5-flash-preview-native-audio-09-17**: "the current time in Tokyo Japan is 9:30 a.m."

**gemini-live-2.5-flash-native-audio**: "it's 9:30 a.m. in Tokyo Japan right now"
...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.11.14/x64/lib/python3.11/site-packages/google/adk/agents/llm_agent.py", line 492, in _run_live_impl
    async for event in agen:
  File "/opt/hostedtoolcache/Python/3.11.14/x64/lib/python3.11/site-packages/google/adk/flows/llm_flows/base_llm_flow.py", line 130, in run_live
    async with llm.connect(llm_request) as llm_connection:
  File "/opt/hostedtoolcache/Python/3.11.14/x64/lib/python3.11/contextlib.py", line 210, in __aenter__
    return await anext(self.gen)
           ^^^^^^^^^^^^^^^^^^^^^
  File "/opt/hostedtoolcache/Python/3.11.14/x64/lib/python3.11/site-packages/google/adk/models/google_llm.py", line 405, in connect
