...
**gemini-live-2.5-flash-preview-native-audio**:
  - Text (audio transcript): ❌ FAIL (retries: 2) - Reason: Exception: 1007 None. Non-existing model: 'gemini-2.5-flash-preview-dialog' from Model Management Protoconf.
  - Voice: ❌ FAIL (retries: 2) - Reason: Exception: 1007 None. Non-existing model: 'gemini-2.5-flash-preview-dialog' from Model Management Protoconf.
...
**gemini-2.5-flash-native-audio-preview-12-2025**: "the current time in Tokyo Japan is 0931 a.m."
...
**gemini-live-2.5-flash-preview-native-audio-09-17**: "the current time in Tokyo Japan is 9:32 a.m. in the morning"

**gemini-live-2.5-flash-native-audio**: "the current time in Tokyo Japan is 0933 a.m."
...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.11.15/x64/lib/python3.11/site-packages/websockets/asyncio/connection.py", line 322, in recv
    raise self.protocol.close_exc from self.recv_exc
websockets.exceptions.ConnectionClosedError: received 1007 (invalid frame payload data) Non-existing model: 'gemini-2.5-flash-preview-dialog' from Model Management Protoconf.; then sent 1007 (invalid frame payload data) Non-existing model: 'gemini-2.5-flash-preview-dialog' from Model Management Protoconf.
...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.11.15/x64/lib/python3.11/site-packages/google/genai/errors.py", line 163, in raise_error
    raise cls(status_code, response_json, response)
google.genai.errors.APIError: 1007 None. Non-existing model: 'gemini-2.5-flash-preview-dialog' from Model Management Protoconf.
```
...
- **gemini-live-2.5-flash-preview-native-audio (text)**: Unexpected failure - requires investigation
  - Failure Reason: Exception: 1007 None. Non-existing model: 'gemini-2.5-flash-preview-dialog' from Model Management Protoconf.
- **gemini-2.0-flash-exp (voice)**: Unexpected failure - requires investigation
  - Failure Reason: Exception: 1008 None. Publisher Model `projects/gcp-samples-ic0/locations/us-central1/publishers/google/models/gemini-2.0-flash-exp` was not foun
