...
## Test Summary
- **Test Date**: 2026-03-13 00:35:02
- **Test Type**: COMBINED (Text + Voice)
- **Google ADK Version**: 1.27.0
- **Total Tests**: 14
- **Passed Tests**: 8
- **Failed Tests**: 6
- **Success Rate**: 57.1%
...
**gemini-2.5-flash-native-audio-preview-09-2025**: "the current time in Tokyo Japan is 9:33 a.m."

**gemini-2.5-flash-native-audio-preview-12-2025**: "the time in Tokyo Japan is 9:33 a.m."
...
**gemini-live-2.5-flash-preview-native-audio-09-17**: "the current time in Tokyo Japan is 9:34 a.m."

**gemini-live-2.5-flash-native-audio**: "it's currently 9:34 a.m. in Tokyo Japan"
...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.11.15/x64/lib/python3.11/site-packages/google/adk/runners.py", line 1094, in execute
    async for event in agen:
  File "/opt/hostedtoolcache/Python/3.11.15/x64/lib/python3.11/site-packages/google/adk/agents/base_agent.py", line 336, in run_live
    async for event in agen:
